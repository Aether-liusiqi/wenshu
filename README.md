...
不想自己装工具和配环境？把要点发我，我跑 wenshu 帮你出稿。

- **9.9 元/篇** — 30 秒内交付初稿
- 支持全部 15 种法定文种 + 7 种事务文书
- 含 docx 导出 + 格式合规检查（GB/T 9704-2012）
- 严格遵循《党政机关公文处理工作条例》（中办发〔2012〕14号）

**微信扫码下单，9.9 元/篇：**

![专业公文代写收款码](wenshu-payment-qr.jpg)

---

## 🛠️ 私有部署 / 企业定制

机关单位或企业需要**本地部署**（数据不出内网、满足保密合规要求）：

- 离线运行，不依赖外部 API
- 可定制文种模板、单位版头、发文编号规则
- 提供部署文档与运维支持

请联系：GitHub Issues 或扫码上方加微信备注"私有部署"

---

## 作者

**刘飔齐（Siqi Liu）** — AI 应用开发者，已开源 8 个 AI 技能工具（投资研究、占星、公文写作等），全部 MIT 许可。GitHub: [@Aether-liusiqi](https://github.com/Aether-liusiqi)
